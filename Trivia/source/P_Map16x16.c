...
{
	BGCTRL_SUB[0] = BG_32x32 | BG_COLOR_256 | BG_MAP_BASE(31) | BG_TILE_BASE(5);
...
void P_Map16x16_configureBG0()
{
	...
	BGCTRL[0] = BG_32x32 | BG_COLOR_16 | BG_MAP_BASE(31) | BG_TILE_BASE(5);
...
void P_Map16x16_configureBG3()
{
	...
	BGCTRL[3] = BG_32x32 | BG_COLOR_16 | BG_MAP_BASE(0) | BG_TILE_BASE(1);

	//Copy tiles, map and palette in the memory (use swicopy or memcpy)
	dmaCopy(backgroundTiles, BG_TILE_RAM(1), (backgroundTilesLen-32));
